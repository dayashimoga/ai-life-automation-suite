...
with open(
    "h:/intelligence/ai-life-automation-suite/docs/test_coverage_report.md", "w"
) as f:
    ...
    for app in apps:
        ...
        result = subprocess.run(
            ["pytest", f"--cov=apps/{app}", f"apps/{app}/tests/", "-v"],
            cwd="h:/intelligence/ai-life-automation-suite",
            capture_output=True,
            text=True,
        )
